...
#readpanmanagerformat(\%Gapplication_groups, \%Gaddress_groups, \%Gaddresses, \%Gservices, \%Gservice_groups, \%Gtags, $goFile, $inputDir);
#readpanmanagerformat(\%application_groups, \%address_groups, \%addresses, \%services, \%service_groups, \%tags, $vsysobjFile, $inputDir);
#readpanmanagerformat(\%application_groups, \%address_groups, \%addresses, \%services, \%service_groups, \%tags, $sharedobjFile, $inputDir);

# read this file
readpanmanagerformat(\%application_groups, \%address_groups, \%addresses, \%services, \%service_groups, \%tags, $database, $inputDir);

readAppIDs(\%appids, \%appNames, $appidfile, $staticDir);
...
sub readAppIDs {
        ...
        my ( $appids_ref, $appNames_ref, $appfile, $dir  ) = @_;
...
sub usage {
        ...
        print "\t\t\t \'pa_global\' for Palo Alto Shared Objects\n";
        print "Optional:\n\n";
        ...
        print "\t--ipvf                         : (in combination with --obj) outputs ip/cidr format for address/address-group contents\n";
        ...
        print "\t--dump [csv|json]     		: prints the database, expanded tags and rules\n";
        ...
        print "\tsudo panquery.pl --db panmanager-output-file.csv --obj SPLUNK-INBOUND_APPIDS\n";
        print "\tsudo panquery.pl --db panmanager-output-file.csv --obj SPLUNK-INBOUND_SERVICES\n";
        print "\tsudo panquery.pl --db panmanager-output-file.csv --obj SPLUNK-SERVERS\n";
        print "\tsudo panquery.pl --db panmanager-output-file.csv --obj SPLUNK-TAG\n";
        print "\tsudo panquery.pl --db panmanager-output-file.csv --obj host-1.1.1.1m32\n";
        print "\tsudo panquery.pl --db panmanager-output-file.csv --obj GLOBAL-SPLUNK_HOSTS --ipvf\n";
        print "\tsudo panquery.pl --db panmanager-output-file.csv --obj SPLUNK --regex\n";
        print "\tsudo panquery.pl --db panmanager-output-file.csv --grp TCP-8888\n";
        print "\tsudo panquery.pl --db panmanager-output-file.csv --grp webdav\n";
        print "\tsudo panquery.pl --db panmanager-output-file.csv --grp host-1.1.1.1m32\n";
        print "\tsudo panquery.pl --db panmanager-output-file.csv --grp network-10.0.0.0m8 --match\n";
        ...
        print "\tsudo panquery.pl --db panmanager-output-file.csv --rule dtls\n";
        print "\tsudo panquery.pl --db panmanager-output-file.csv --rule TCP-1521\n";
        print "\tsudo panquery.pl --db panmanager-output-file.csv --rule host-1.1.1.1m32\n";
        print "\tsudo panquery.pl --db panmanager-output-file.csv --rule 8.8.8.8 --match\n";
        print "\tsudo panquery.pl --db panmanager-output-file.csv --rule SPLUNK-TAG\n";
        print "\tsudo panquery.pl --db panmanager-output-file.csv --rule SPLUNK-TAG --debug\n";
